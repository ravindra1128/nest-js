...
let ReviewsService = class ReviewsService {
    ...
    async getReviews(eventId) {
        try {
            logger_1.logger.info('=====getReviewes request initiated====');
    ...
    async createReview(eventId, user, payload) {
        try {
            logger_1.logger.info('=====createreview request initiated====');
            const { uid } = user;
            ...
            if (userRecord) {
                ...
                return (0, response_1.api_response)(review, 201, 'Review created successfully');
            }
        }
        catch (error) {
            logger_1.logger.error(error);
